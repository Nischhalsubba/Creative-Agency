...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`codex/refactor-codebase-to-2026-standards-1fq1bw`](https://github.com/Nischhalsubba/Creative-Agency/tree/codex/refactor-codebase-to-2026-standards-1fq1bw). It is generated from the files present on this branch and preserves the project-authored README below.
...
```mermaid
flowchart LR
    CHANGE["Change on codex/refactor-codebase-to-2026-standards-1fq1bw"]
